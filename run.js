...
function getOverviewLine(data) {
   return "<tr>" + "<td align=\"right\">" + data.name + "</td>" + "<td align=\"right\">" + getEuroString(data.cent / 100) + "</td>" + "<td align=\"right\">" + data.orders + "</td>" + "<td align=\"right\">" + data.products + "</td>" + "<td align=\"right\">" + getEuroString(data.cent / 100 / data.products) + "</td>" + "<td align=\"right\">" + getEuroString(data.cent / 100 / data.month) + "</td>" + "</tr>";
}
...
function getOrderLine(data) {
   ...
   nameList += "</ul>";
   return "<tr>" + "<td align=\"center\" valign=\"top\"><a href=\"" + data.link + "\">Link</a></td>" + "<td align=\"right\" valign=\"top\">" + data.date + "</td>" + "<td align=\"center\" valign=\"top\">" + data.products + "</td>" + "<td align=\"right\" valign=\"top\">" + data.price + "</td>" + "<td align=\"left\" valign=\"top\">" + nameList + "</td>" + "</tr>";
}
...
function printOrders() {
   ...
   text += "<table cellspacing=\"0\" cellpadding=\"4\" border=\"1\"><tr>" + "<th>Jahr</th>" + "<th>Euro</th>" + "<th>Bestell.</th>" + "<th>Produkte</th>" + "<th>Euro/Prod.</th>" + "<th>Euro/Monat</th>" + "</tr>";
   ...
   text += "<table cellspacing=\"0\" cellpadding=\"4\" border=\"1\"><tr>" + "<th>Link</th>" + "<th>Datum</th>" + "<th>Produkte</th>" + "<th>Preis</th>" + "<th>Produktbeschreibungen</th>" + "</tr>";
...
function loadYear(event) {
   ...
   for(var i = 0; i <= maxIndex; i += 10) {
      orders[year].pages.push({
         "done": false,
         "entries": []
      });
   }
   findOrders(doc, year, 0);
   var pageUri = "https://www.amazon.de/gp/css/order-history/gp/css/order-history/ref=oss_pagination?ie=UTF8&orderFilter=" + orders[year].year + "&search=&startIndex=";
   var pageIndex = 1;
